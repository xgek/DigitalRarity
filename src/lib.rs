// src/lib.rs
/*
 * Core library for DigitalRarity
 */
...
#[derive(Debug)]
pub struct DigitalRarityProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DigitalRarityProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DigitalRarity processing");
    
    let mut processor = DigitalRarityProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DigitalRarityProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DigitalRarityProcessor::new(false);
